  ...
  return (
    <section className="bg-orange-50 h-188 lg:h-360">
      <div className="flex flex-row">
        ...
        <img className="w-1/3" src="/src./assets/eb363b30e536cf875c898563a7beb1193b6367c6-2400x3000.jpeg" />
      </div>
      ...
      <div className="bg-orange-50">
        <img
          ...
          src="/src/assets/87ab0c507bf346ef6ae58ed29e845c368f4ccb1e-2400x3000.jpeg"
          alt="Product image"
        />
      </div>
      <div className="bg-orange-50">
