    ...
    <section className="bg-orange-50 h-188 lg:h-360">
      <div className="flex flex-row">
        <div className="card bg-base-300 rounded-box grid h-20 grow place-items-center">
          <img className="w-4/4" src="/src/assets/cb061929ab51d1e0bde75636b581a3eee071ba31-2400x3000.jpg" />
        </div>
        <div className="card bg-base-300 rounded-box grid h-20 "></div>
        <img className="w-1/3" src="/src/assets/eb363b30e536cf875c898563a7beb1193b6367c6-2400x3000.jpg" />
      </div>
      ...
      <div className="bg-orange-50">
        <img
          ...
          src="/src/assets/87ab0c507bf346ef6ae58ed29e845c368f4ccb1e-2400x3000.jpg"
          alt="Product image"
        />
      </div>
      <div className="bg-orange-50">
