...
function ImageTwo () {
  ...
  <img className="w-1/3" src='/src/assets/7f5d941574e28349ff2b7e76975e1c1a69ad43a0-2400x3000.avif'/>
  <div className="card bg-base-300 rounded-box grid h-20 grow place-items-center">
  <img className="w-2/2" src='/src/assets/67c7c3592f3f36904e5a09f81b572c4f302ceab3-2400x3000.avif' /></div>
</div>
